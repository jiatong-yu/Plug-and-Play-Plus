...
def load_model(logger, model_name):
    ...
    if "gpt2" in model_name:
        ...
        tokenizer = GPT2Tokenizer.from_pretrained(model_name, cache_dir = "/n/fs/nlp-jiatongy/iw22fall/base/.cache")
        ...
        model = GPT2LMHeadModel.from_pretrained(
            ...
            cache_dir = "/n/fs/nlp-jiatongy/iw22fall/base/.cache",
            offload_folder = "/n/fs/nlp-jiatongy/iw22fall/base/.offload"
            )
    ...
    if "opt" in model_name:
        ...
        tokenizer = AutoTokenizer.from_pretrained(model_name, use_fast=False, cache_dir="/n/fs/nlp-jiatongy/iw22fall/base/.cache")
        return model, tokenizer 
